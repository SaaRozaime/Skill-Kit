  ...
  <div class="container">
    ...
    <div class="main-content">
      ...
      <div class="left-section">
        <a href="{{ route('usermanagement') }}" class="box-link">
          <button class="box-button">User Management</button>
        </a>
        <a href="{{ route('notifs') }}" class="box-link">
          <button class="box-button">Announcement & Notifications</button>
        </a>
        <a href="{{ route('system') }}" class="box-link">
          <button class="box-button">System Maintenance</button>
        </a>
        <a href="{{ route('adminaccesscontrol') }}" class="box-link">
          <button class="box-button">Access Control</button>
        </a>
      </div>
