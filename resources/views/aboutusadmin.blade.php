    ...
    <div class="main-content">
      ...
      <div class="left-section">
        <div class="message-card">
          ...
          <ul>
            <li>User Management: Manage and oversee student and mentor accounts.</li>
            <li>Announcements & Notifications: Keep students and mentors updated with important announcements.</li>
            <li>System Maintenance: Maintain and monitor the platform to ensure smooth operation.</li>
            <li>Access Control: Manage user permissions and access levels for different roles.</li>
          </ul>
