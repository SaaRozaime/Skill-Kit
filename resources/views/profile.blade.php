    ...
    <div class="main-content">
      ...
      <div class="left-section">
        <div class="profile-card">
          <img src="images/FINN.png" alt="Profile Picture"/>
          <h2>Ampuan Muhammad Abdul Matin Bin Ampuan Shahmali</h2>
          <p>Medical Student | Politeknik Brunei</p>
          <p><strong>ID:</strong> 23FTT1018</p>
          <p><strong>Group Code:</strong> DDAT02</p>
          <p><strong>Email Address:</strong> 23FTT1018@student.pb.edu.bn</p>
